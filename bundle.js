...
if(false) {
	module.hot.accept("!!./node_modules/css-loader/index.js??ref--1-1!./General.css", function() {
		var newContent = require("!!./node_modules/css-loader/index.js??ref--1-1!./General.css");
...
var _Shopping = __webpack_require__(33);
...
(0, _reactDom.render)(_react2.default.createElement(_Shopping2.default, null), document.getElementById('root'));
...
var _ProductsContainer = __webpack_require__(48);
...
var Shopping1 = function (_Component) {
    _inherits(Shopping1, _Component);

    function Shopping1() {
        _classCallCheck(this, Shopping1);

        var _this = _possibleConstructorReturn(this, (Shopping1.__proto__ || Object.getPrototypeOf(Shopping1)).call(this));
    ...
    _createClass(Shopping1, [{
        ...
        value: function addCart(index) {
            ...
            var cart = this.state.selectProducts;
        ...
        value: function searchItem(itemName) {
            var productsModel = [{ 'index': '0', 'path': '/images/apple.jpg', 'name': 'apple' }, { 'index': '1', 'path': '/images/pear.jpg', 'name': 'pear' }, { 'index': '2', 'path': '/images/watermelen.jpg', 'name': 'watermelen' }, { 'index': '3', 'path': '/images/banana.jpg', 'name': 'banana' }];
            var finditem = false;
            if (itemName == "") {
        ...
        key: 'handleRemove',
        value: function handleRemove(quantity, id, event) {
            var originalQty = [10, 8, 15, 5];
            var productsModel = [{ 'index': '0', 'path': '/images/apple.jpg', 'name': 'apple' }, { 'index': '1', 'path': '/images/pear.jpg', 'name': 'pear' }, { 'index': '2', 'path': '/images/watermelen.jpg', 'name': 'watermelen' }, { 'index': '3', 'path': '/images/banana.jpg', 'name': 'banana' }];
            var selProducts = this.state.selectProducts;
            var pname = productsModel[id].name;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'row', style: { "margin-left": "5%" } },
                        _react2.default.createElement(
                            'div',
                            { className: 'col-md-8' },
                            _react2.default.createElement(_Search2.default, { searchItem: this.searchItem.bind(this) }),
                            _react2.default.createElement('hr', null),
                            _react2.default.createElement(_ProductsContainer2.default, { addCart: this.addCart.bind(this), products: this.state.filterProducts, qty: this.state.qty })
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'col-md-3' },
                            _react2.default.createElement(_Cart2.default, { handleRemove: this.handleRemove.bind(this), selectProducts: this.state.selectProducts, qty: this.state.selectQty, pModel: this.state.products })
                        )
                    ),
                    _react2.default.createElement(
                        'div',
...
var _EmptyCart = __webpack_require__(44);
...
var Cart = function (_Component) {
    ...
    _createClass(Cart, [{
        ...
        value: function handleClick() {
            ...
            //event.preventDefault();
            setTimeout(function () {
                _this2.setState({ showCart1: !_this2.state.showCart1 });
            }, 0);
        }
    }, {
        key: 'handleRemove',
        value: function handleRemove(product, index) {
            var _this3 = this;

            this.props.handleRemove(product, index);
            setTimeout(function () {
                _this3.setState({ showCart1: !_this3.state.showCart1 }), 0.1;
            });
            setTimeout(function () {
                _this3.setState({ showCart1: !_this3.state.showCart1 }), 0.2;
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var selProducts = this.props.selectProducts;

            //const selProducts = this.props.selectProducts;
            var len = selProducts.length;
            var view = void 0;
            var totalPrice = 0;
            ...
            if (len == 0) {
                ...
                cartItems = this.props.qty.map(function (product, index) {
                    return product > 0 ? _react2.default.createElement(
                        'li',
                        { className: 'cart-item', key: _this4.props.pModel[index].name },
                        _react2.default.createElement('img', { className: 'product-image', src: _this4.props.pModel[index].path }),
                        _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement(
                                'p',
                                null,
                                _this4.props.pModel[index].name
                            ),
                            _react2.default.createElement(
                                'p',
                                null,
                                _this4.props.pModel[index].price
                            ),
                            _react2.default.createElement(
                                'p',
                                null,
                            ...
                            _react2.default.createElement(
                                ...
                                null,
                                'Total Price:',
                                product * _this4.props.pModel[index].price
                            )
                        ),
                        _react2.default.createElement(
                            'button',
                            { onClick: _this4.handleRemove.bind(_this4, product, index) },
                            'Remove items'
                        )
                    ) : null;
                });
                ...
                view = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        { transitionName: 'fadeIn', transitionEnterTimeout: 1, transitionLeaveTimeout: 1, component: 'ul', className: 'cart-items' },
                        cartItems
                    )
                );
            }
            return _react2.default.createElement(
                'div',
                { className: 'container', style: { "padding": "100px 50px 10px;" } },
                _react2.default.createElement(
                    'button',
                    { id: 'popbtn', type: 'button', className: 'btn btn-success',
...
if(false) {
	module.hot.accept("!!./node_modules/css-loader/index.js??ref--1-1!./Cart.css", function() {
		var newContent = require("!!./node_modules/css-loader/index.js??ref--1-1!./Cart.css");
...
// module
exports.push([module.i, ".Cart__cart--D7AGu{\r\n    display: flex;\r\n    display: -webkit-flex;\r\n    margin-left: 64px;\r\n    position: relative;\r\n    z-index: 99;\r\n    \r\n}\r\n\r\n.Cart__cart-items--1Y8mT{\r\n    height: 320px;\r\n    width: 360px;\r\n}\r\n.Cart__cart-item--i0NXH{\r\n    display: flex;\r\n    display: -webkit-flex;\r\n    align-items: center;\r\n    -webkit-align-items: center;\r\n    padding: 8px;\r\n}\r\n.Cart__product-image--fkuWZ{\r\n        width: 48px;\r\n        height: 48px;\r\n}\r\n\r\n", ""]);

// exports
exports.locals = {
	"cart": "Cart__cart--D7AGu",
	"cart-items": "Cart__cart-items--1Y8mT",
	"cart-item": "Cart__cart-item--i0NXH",
	"product-image": "Cart__product-image--fkuWZ"
};
...
var _Picframe = __webpack_require__(49);

var _Picframe2 = _interopRequireDefault(_Picframe);
...
var ProductsContainer = function (_Component) {
    ...
    function ProductsContainer(props) {
        ...
        return _possibleConstructorReturn(this, (ProductsContainer.__proto__ || Object.getPrototypeOf(ProductsContainer)).call(this, props));
    }
            ...
            if (this.props.products.length != 0) {
                return _react2.default.createElement(
                    ...
                    this.props.products.map(function (item, index) {
                        return _react2.default.createElement(_Picframe2.default, { addToCart: _this2.props.addCart, quantity: _this2.props.qty[index], source: item.path, key: index, index1: index, name: item.name });
                    })
                );
            } else {
                return _react2.default.createElement(
...
var Picframe = function (_Component) {
    _inherits(Picframe, _Component);

    function Picframe() {
        _classCallCheck(this, Picframe);

        return _possibleConstructorReturn(this, (Picframe.__proto__ || Object.getPrototypeOf(Picframe)).apply(this, arguments));
    }

    _createClass(Picframe, [{
        key: 'handleClick',
        value: function handleClick() {
        ...
        key: 'render',
        value: function render() {
            var popid = this.props.name + this.props.index1;
            return _react2.default.createElement(
                'div',
                { className: 'col-md-6 col-sm-8 col-xs-8' },
                _react2.default.createElement('img', { src: this.props.source, style: { "cursor": "pointer", 'max-width': '100%' }, 'data-toggle': 'modal', 'data-target': "#" + popid }),
                _react2.default.createElement(
                    'div',
                    { 'class': 'row' },
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-5', style: { 'float': 'left' } },
                        _react2.default.createElement(
                            'button',
                            { onClick: this.handleClick.bind(this), className: 'form-control' },
                            _react2.default.createElement(
                                'span',
                                null,
                                'Add To Cart'
                ...
                _react2.default.createElement('div', { className: _General2.default.clear }),
                _react2.default.createElement(
                    'div',
                    { className: 'modal fade', id: popid, tabindex: '-1', role: 'dialog', 'aria-labelledby': 'myModalLabel', 'aria-hidden': 'true' },
                    _react2.default.createElement(
                        'div',
                        { className: 'modal-dialog' },
                        _react2.default.createElement('img', { src: this.props.source, className: _General2.default.imgPop })
                    )
                )
            );
        }
...
// module
exports.push([module.i, "html {\r\n    box-sizing: border-box;\r\n    -ms-text-size-adjust: 100%;\r\n    -webkit-text-size-adjust: 100%;\r\n  }\r\n  \r\n  *, *:before, *:after {\r\n    box-sizing: inherit;\r\n  }\r\n  \r\n  body {\r\n    margin: 0;\r\n    font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;\r\n    background-color:lightgrey;\r\n  }\r\n  \r\n  h1, h2, h3, h4, h5, h6, p, ul {\r\n    margin: 0;\r\n    padding: 0;\r\n  }\r\n\r\n  .General__img--3TUZb{\r\n      max-height:10%;\r\n      max-width:10%;\r\n  }\r\n\r\n  .General__imgContainer--y_Tu0{\r\n    max-width:15%;\r\n    background-color:lightgrey;\r\n  }\r\n\r\n  .General__btnfor--3N5zp{\r\n      float:right;\r\n  }\r\n\r\n  .General__clear--14F6x{\r\n      clear:both;\r\n  }\r\n\r\n  .General__imgPop--3CgM6{\r\n    width:100%;\r\n    height:100%;\r\n  }\r\n  \r\n  .General__cartitems--2yOwk{\r\n    height: 10%;\r\n    width: 15;\r\n}\r\n.General__cart-item--2k39i{\r\n    display: flex;\r\n    display: -webkit-flex;\r\n    align-items: center;\r\n    -webkit-align-items: center;\r\n    padding: 8px;}\r\n    .General__product-image--3gV6q{\r\n        width: 48px;\r\n        height: 48px;\r\n    }", ""]);

// exports
exports.locals = {
	"img": "General__img--3TUZb",
	"imgContainer": "General__imgContainer--y_Tu0",
	"btnfor": "General__btnfor--3N5zp",
	"clear": "General__clear--14F6x",
	"imgPop": "General__imgPop--3CgM6",
	"cartitems": "General__cartitems--2yOwk",
	"cart-item": "General__cart-item--2k39i",
	"product-image": "General__product-image--3gV6q"
};
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col-md-8' },
                            _react2.default.createElement('input', { className: 'form-control', id: 'search', type: 'text', placeholder: 'Please input here' })
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'col-md-3' },
                            _react2.default.createElement(
                                'button',
                                { className: 'btn', onClick: this.handleClick.bind(this) },
                                'Search'
                            )
                        )
                    )
